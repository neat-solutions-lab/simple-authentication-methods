...
@SpringBootTest(webEnvironment = SpringBootTest.WebEnvironment.RANDOM_PORT, classes = [FakeIntegrationApplicationConfig::class])
@TestPropertySource(properties = ["sam.passwords-file=src/integration-test/config/passwords.conf"])
class FakeIntegrationApplicationIT {
