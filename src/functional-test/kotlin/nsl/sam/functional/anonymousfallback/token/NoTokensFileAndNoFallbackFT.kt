...
class NoTokensFileAndNoFallbackFT {

    @Autowired
    private lateinit var mvc: MockMvc

    @Test
    fun failedAuthenticationWithValidTokenOtherwiseWhenNoFallbackAndNoTokensFile() {
    ...
    @Test
    fun failedAccessWithNoCredentialsAtAllWhenNoFallbackAndNoTokensFile() {
        // ACT
