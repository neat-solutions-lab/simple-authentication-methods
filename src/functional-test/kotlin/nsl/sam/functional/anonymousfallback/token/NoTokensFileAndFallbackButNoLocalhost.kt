...
class NoTokensFileAndFallbackButNoLocalhost {

    @Autowired
    private lateinit var mvc: MockMvc

    @Test
    fun failedAuthenticationWithValidTokenOtherwiseWhenFallbackAndNoTokensFileButNoLocalhost() {
    ...
    @Test
    fun failedAccessWithNoCredentialsAtAllWhenFallbackAndNoTokensFileButNoLocalhost() {
        // ACT
